    ...
    <section className='relative w-full h-screen bg-gradient-to-l from-sky-400 via-sky-300 to-cyan-200 flex flex-col-reverse md:flex-row items-center justify-center overflow-hidden px-6 md:px-16'>
      ...
      >
        ...
        <div className="mt-2 flex space-x-4">
          <button className="px-6 py-3 bg-white text-sky-600 font-semibold rounded-full shadow-lg hover:bg-sky-50 hover:scale-105 transition-transform duration-300">
            Get Started
          </button>
      ...
      <div className="absolute top-10 left-10 w-64 h-64 bg-white/30 rounded-full blur-3xl">asd</div>
